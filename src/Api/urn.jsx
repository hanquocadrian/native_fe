...
export const urnChartNumberOfAdminAccount = '/api/chart/get-number-of-admin-account';
export const urnChartNumberOfNativeHotelAccount = '/api/chart/get-number-of-native-hotel-account';
